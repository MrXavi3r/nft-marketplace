...
contract NFTMarket is ReentrancyGuard {
    using Counters for Counters.Counter; // used to increment/decrement values
    ...
    // fetches all items in the marketplace
    ...
    // fetches all items in the marketplace that match the address of the msg.sender
